...
#line 3684 "frontend/parser.cpp"
    break;

  case 450: // type: mattype
#line 826 "frontend/parser.yy"
                        { yylhs.value.as < ptc::ir::IR * > () = yystack_[0].value.as < ptc::ir::IR * > (); }
#line 3690 "frontend/parser.cpp"
    break;


#line 3694 "frontend/parser.cpp"
